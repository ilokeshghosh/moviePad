export default function Construction() {
  return (
    ...
    <div className="bg-white relative h-screen w-screen overflow-hidden flex justify-center items-center">
      ...
      {/* content wrapper */}
      <div
        className="absolute bg-black/90 h-full w-full flex justify-center items-center"
        style={{ fontFamily: "DM Serif Display, sans-serif" }}
      >
        <h1 className="text-[#6EEB83] md:text-7xl text-3xl text-center w-full uppercase">
