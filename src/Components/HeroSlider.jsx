              ...
              {index === current && (
                <>
                  ...
                  <div
                    ...
                    style={{ backgroundImage: `url(${slide.banner})`, boxShadow:'inset 0px -200px 100px 0px rgb(2 6 23)' }}
                  >
                  ...
                  >
                    ...
                    <button className="bg-red-700 px-6 py-2 rounded-lg text-xl font-bold ">Click Me</button>

                    {/* shadow */}
                    <div
                      className="w-[120%] absolute  -bottom-10 text-center h-10  bg-center bg-cover bg-no-repeat"
                      style={{ backgroundImage:'url(https://ik.imagekit.io/8fgpvoiai/MoviePad/card%20shadow_R3lUESlaA.png?updatedAt=1704194324494)' }}
                    ></div>
                  </div>
                </>
              )}
